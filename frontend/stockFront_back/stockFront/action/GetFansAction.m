...
- (void)pullDownAction:(pullCompleted)completedBlock list:(NSMutableArray *)list tableview:(UITableView *)tableview
{
    ...
    NSDictionary* message = [[NSDictionary alloc]
                             ...
                             forKeys:@[@"followed_user_id", @"follow_timestamp"]];
    
    [NetworkAPI callApiWithParam:message childpath:@"/user/getFansUser" successed:^(NSDictionary *response) {
